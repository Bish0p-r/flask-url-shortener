...
url_shortener_input_model = api.model(
    "UrlInput",
    {"original_url": fields.String(required=True, description="The original URL")},
)


url_shortener_patch_model = api.model(
    "Url", {"short_url": fields.String(required=True)}
)


user_model = api.model("UserModel", {"id": fields.Integer, "email": fields.String})
...
user_profile_patch_model = api.model(
    "UserProfileModel",
    {
